...
console.log("modified object", circle2);
...
//Create Object
const circle3 = createFactoryCircle(2, { x: 1, y: 2 });
...
const circle4 = new ConstructorCircle(6, { x: 15, y: -2 }).draw();
